...
class Firefly {
            ...
            float flashTime)
  {
    ...
    fireParticle = new Particle(new PVector(random(width), random(height)));
  }
  
  //void setParticlePosition(PVector startLoc){
  //  fireParticle.setLoc(startLoc);
  //}
  
  void displayParticle(){
    
    fireParticle.run(this);
